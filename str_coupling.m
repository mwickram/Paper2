function str_coupling

data=load('m010809_13.dat');
dar=200;
...
nc=100;
tc=t(1:nc:end);
gc=plot(tc,pdd(1:nc:end,1),'k',tc,pdd(1:nc:end,2),'r',tc,pdd(1:nc:end,3),'b');
set(gc,'linewidth',0.3);
ylabel('\Delta\phi \rm(rad)','FontName','Arial')
xlabel('\itt \rm(s)','FontName','Arial')
xlim([0 600]);ylim([-100 100]);
...
set(gc(1),'linewidth',1);%dashed line
set(gc(2),'linewidth',1);% thick line
set(gc(3),'linewidth',0.3);% thin line
